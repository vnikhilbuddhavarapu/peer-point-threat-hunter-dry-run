/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2d39b626a56172a2f71f02eeb318b096)
// Runtime types generated with workerd@1.20260911.1 2026-09-18 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	AI_GATEWAY_ID: "default";
	LOG_API_URL: "https://peer-point-log-api.peer-point-user-group.workers.dev";
	CITY: "Montreal";
	CARD: "threat-hunter";
	ENVIRONMENT: "solution";
	THREAT_HUNTER_AGENT: DurableObjectNamespace<import("./src/server").ThreatHunterAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "ThreatHunterAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_ID" | "LOG_API_URL" | "CITY" | "CARD" | "ENVIRONMENT">> {}
}
